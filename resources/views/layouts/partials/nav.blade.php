...
<header role="banner" class="clearfix custom">
        <div class="visibility"></div>
        <a class="logo sanders-logo" href="/" title="Home">
<img src="/assets/signature.svg">
        </a>
        <nav>
            <button type="button" class="expand">Цэс<span class="bar"></span><span class="bar"></span><span class="bar"></span></button>
            <ul id="menu-main-menu" class="menu">
                <li id="menu-item-821" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-821"><a href="/">Нүүр</a></li>
                <!-- <li id="menu-item-821" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-821"><a href="/about">УУЛЗАХ</a></li> -->
        ...
        <nav class="full-nav clearfix">
            <div class="nav-container">
                <h2>Цэс <button type="button" class="close">Хаах</button></h2>
                <div class="navgroup">
                    <h3>Дэд цэс</h3>
                    <ul id="menu-learn" class="menu">
                        <li id="menu-item-871" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-425 current_page_item menu-item-871"><a href="/">НҮҮР</a></li>
                        <!-- <li id="menu-item-871" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-425 current_page_item menu-item-871"><a href="/about">УУЛЗАХ</a></li> -->
        ...
        <div class="es-link" style="display:none">
            <a href="https://zandanshatar.com/en/">English</a>
        </div>
    </header>