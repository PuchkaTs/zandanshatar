    <div class="footer-offset">
        <footer>
            <nav class="clearfix">
                <div class="navgroup">
                    <h3>Нүүр</h3>
                    <ul id="menu-learn-1" class="menu">
                        <!-- <li class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-425 current_page_item menu-item-871"><a href="/about">Уулзах</a></li> -->
                        <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-820"><a href="/issues">Зорьж буй ажлууд</a></li>
                        <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-869"><a href="/news">Мэдээ мэдээлэл</a></li>
                        <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-15206"><a href="/talks">Ярилцлага</a></li>
                        <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-826"><a href="/reader">Ном унших</a></li>
                    </ul>
                </div>
                <div class="navgroup">
                    <h3>Дагах</h3>
            ...
            <p><span class="copyright">© Zandanshatar 2017</span> | <a href="http://airkreativ.com">AirKreativ</a></p>
        </footer>
    </div>